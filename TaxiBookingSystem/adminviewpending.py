...
class PendingBookings(QWidget):
    ...
    def initUI(self):
        ...
        booking_query = "SELECT * FROM booking WHERE BookingStatus = 'Pending'"
        self.bookings = self.db.execute_query(query=booking_query, fetch_all=True)
    ...
    def handle_view_click(self, index):
        ...
        self.booking_widget = BookingWidget(booking=self.bookings[index], db_path=self.db_path, is_to_approve=True)
